...
1. **SDRAM:**
  ...
  Stands for synchronous DRAM. This type of RAM is synchronized o our systems’; clock speed, allowing quicker processing of data.
2. **DDR SDRAM:**
...
MB is a megabyte or unit of data storage, while Mb/s is a megabit per second, which is a unit of data transfer rate.
2.  **DVI:**
